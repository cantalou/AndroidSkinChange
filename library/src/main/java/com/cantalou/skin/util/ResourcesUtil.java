...
public class ResourcesUtil {
    ...
    /**
     * Attempt to programmatically load the packageName from the manifest file of an
     * activity by using an XML pull parser. This should allow us to read the
     * packageName attribute regardless of the platform it is being run on.
     *
     * @param resources Activity instance.
     * @return package name
     */
    public static String loadPackageFromManifest(Resources resources) {
        try {
